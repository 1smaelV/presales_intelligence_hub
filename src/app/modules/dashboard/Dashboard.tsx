...
import { LineChart, Sparkles, Bot, Layers, BadgeCheck, RefreshCcw, FileText, ArrowUpRight } from 'lucide-react';
                ...
                >
                    ...
                    <div className="relative z-10">
                        <div className="bg-teal-50 w-14 h-14 rounded-2xl flex items-center justify-center mb-5 group-hover:bg-teal-600 transition-colors duration-300">
                            <FileText className="w-8 h-8 text-teal-600 group-hover:text-white transition-colors duration-300" />
                        </div>
                        <h3 className="text-xl font-bold text-gray-900 mb-3">Case Studies</h3>
                        <p className="text-gray-500 mb-5 leading-relaxed">Proof points and success stories to share with prospects.</p>
